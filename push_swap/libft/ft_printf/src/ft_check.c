...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/09/15 12:54:42 by nlagache          #+#    #+#             */
/*   Updated: 2016/11/13 18:53:54 by nlagache         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
**		Init tab flag, check corrects flags, add accuracy and width
**		and put f->fla[n] to 1 for each flag
*/
...
int			pf_ft_check(t_flag *f)
{
	...
	if ((size_t)f->ndx == pf_ft_strlen(f->frmt))
		return (-1);
	return (0);
}
